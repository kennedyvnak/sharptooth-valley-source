...
#pragma warning restore 1692
        ...
        bool ICanvasRaycastFilter.IsRaycastLocationValid(Vector2 screenPoint, Camera eventCamera) {
            ...
            try {
                ...
                GameLogger.LogError($"Using alphaHitTestMinimumThreshold greater than 0 on Image whose sprite texture cannot be read. {e.Message} Also make sure to disable sprite packing for this sprite.", this);
                return true;
            }
        }
